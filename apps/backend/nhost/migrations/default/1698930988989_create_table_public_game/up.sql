CREATE TABLE "public"."game" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "teamId" uuid NOT NULL, "time" timestamptz NOT NULL, "nbPlayers" integer NOT NULL, PRIMARY KEY ("id") , FOREIGN KEY ("teamId") REFERENCES "public"."teams"("id") ON UPDATE cascade ON DELETE cascade, FOREIGN KEY ("userId") REFERENCES "auth"."users"("id") ON UPDATE cascade ON DELETE cascade, UNIQUE ("id"));
